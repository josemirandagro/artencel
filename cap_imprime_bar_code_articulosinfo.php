...
$cap_imprime_bar_code_articulos = NULL;

//
// Table class for cap_imprime_bar_code_articulos
//
class ccap_imprime_bar_code_articulos extends cTable {
	var $Id_Etiqueta;
	var $Id_Compra;
	var $Articulo_L1;
	var $Articulo_L2;
	...
	function __construct() {
		...
		$this->TableVar = 'cap_imprime_bar_code_articulos';
		$this->TableName = 'cap_imprime_bar_code_articulos';
		$this->TableType = 'VIEW';
		...
		// Id_Etiqueta
		$this->Id_Etiqueta = new cField('cap_imprime_bar_code_articulos', 'cap_imprime_bar_code_articulos', 'x_Id_Etiqueta', 'Id_Etiqueta', '`Id_Etiqueta`', '`Id_Etiqueta`', 3, -1, FALSE, '`Id_Etiqueta`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Etiqueta->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Etiqueta'] = &$this->Id_Etiqueta;

		// Id_Compra
		$this->Id_Compra = new cField('cap_imprime_bar_code_articulos', 'cap_imprime_bar_code_articulos', 'x_Id_Compra', 'Id_Compra', '`Id_Compra`', '`Id_Compra`', 3, -1, FALSE, '`Id_Compra`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Compra->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Compra'] = &$this->Id_Compra;

		// Articulo_L1
		$this->Articulo_L1 = new cField('cap_imprime_bar_code_articulos', 'cap_imprime_bar_code_articulos', 'x_Articulo_L1', 'Articulo_L1', '`Articulo_L1`', '`Articulo_L1`', 200, -1, FALSE, '`Articulo_L1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Articulo_L1'] = &$this->Articulo_L1;

		// Articulo_L2
		$this->Articulo_L2 = new cField('cap_imprime_bar_code_articulos', 'cap_imprime_bar_code_articulos', 'x_Articulo_L2', 'Articulo_L2', '`Articulo_L2`', '`Articulo_L2`', 200, -1, FALSE, '`Articulo_L2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Articulo_L2'] = &$this->Articulo_L2;

		// Articulo_L3
		$this->Articulo_L3 = new cField('cap_imprime_bar_code_articulos', 'cap_imprime_bar_code_articulos', 'x_Articulo_L3', 'Articulo_L3', '`Articulo_L3`', '`Articulo_L3`', 200, -1, FALSE, '`Articulo_L3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Articulo_L3'] = &$this->Articulo_L3;

		// Codigo
		$this->Codigo = new cField('cap_imprime_bar_code_articulos', 'cap_imprime_bar_code_articulos', 'x_Codigo', 'Codigo', '`Codigo`', '`Codigo`', 200, -1, FALSE, '`Codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Codigo'] = &$this->Codigo;

		// Status
		$this->Status = new cField('cap_imprime_bar_code_articulos', 'cap_imprime_bar_code_articulos', 'x_Status', 'Status', '`Status`', '`Status`', 202, -1, FALSE, '`Status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Status'] = &$this->Status;

		// Articulo
		$this->Articulo = new cField('cap_imprime_bar_code_articulos', 'cap_imprime_bar_code_articulos', 'x_Articulo', 'Articulo', '`Articulo`', '`Articulo`', 200, -1, FALSE, '`Articulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlFrom() { // From
		return "`cap_imprime_bar_code_articulos`";
	}
	...
	// Update Table
	var $UpdateTable = "`cap_imprime_bar_code_articulos`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cap_imprime_bar_code_articuloslist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("cap_imprime_bar_code_articulosview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "cap_imprime_bar_code_articulosadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cap_imprime_bar_code_articulosedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cap_imprime_bar_code_articulosadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cap_imprime_bar_code_articulosdelete.php", $this->UrlParm());
	}
