...
$cap_asigna_acabados_equipo_detail_grid = NULL; // Initialize page object first

class ccap_asigna_acabados_equipo_detail_grid extends ccap_asigna_acabados_equipo_detail {
	...
	// Page object name
	var $PageObjName = 'cap_asigna_acabados_equipo_detail_grid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["cap_asigna_acabados_equipo_detail"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// Id_Acabado_eq
			$this->Id_Acabado_eq->SetDbValueDef($rsnew, $this->Id_Acabado_eq->CurrentValue, 0, $this->Id_Acabado_eq->ReadOnly);
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "cap_asigna_acabados_equipo") {
			...
			if ($GLOBALS["cap_asigna_acabados_equipo"]->EventCancelled) $this->EventCancelled = TRUE;
		}
