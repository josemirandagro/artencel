...
$cap_entrega_sim = NULL;

//
// Table class for cap_entrega_sim
//
class ccap_entrega_sim extends cTable {
	var $Id_Traspaso;
	...
	function __construct() {
		...
		$this->TableVar = 'cap_entrega_sim';
		$this->TableName = 'cap_entrega_sim';
		$this->TableType = 'VIEW';
		...
		// Id_Traspaso
		$this->Id_Traspaso = new cField('cap_entrega_sim', 'cap_entrega_sim', 'x_Id_Traspaso', 'Id_Traspaso', '`Id_Traspaso`', '`Id_Traspaso`', 3, -1, FALSE, '`Id_Traspaso`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Traspaso->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Traspaso'] = &$this->Id_Traspaso;

		// Id_Almacen_Entrega
		$this->Id_Almacen_Entrega = new cField('cap_entrega_sim', 'cap_entrega_sim', 'x_Id_Almacen_Entrega', 'Id_Almacen_Entrega', '`Id_Almacen_Entrega`', '`Id_Almacen_Entrega`', 3, -1, FALSE, '`Id_Almacen_Entrega`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Id_Almacen_Recibe
		$this->Id_Almacen_Recibe = new cField('cap_entrega_sim', 'cap_entrega_sim', 'x_Id_Almacen_Recibe', 'Id_Almacen_Recibe', '`Id_Almacen_Recibe`', '`Id_Almacen_Recibe`', 3, -1, FALSE, '`Id_Almacen_Recibe`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Fecha
		$this->Fecha = new cField('cap_entrega_sim', 'cap_entrega_sim', 'x_Fecha', 'Fecha', '`Fecha`', 'DATE_FORMAT(`Fecha`, \'%d/%m/%Y %H:%i:%s\')', 133, 7, FALSE, '`Fecha`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Fecha->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['Fecha'] = &$this->Fecha;

		// Hora
		$this->Hora = new cField('cap_entrega_sim', 'cap_entrega_sim', 'x_Hora', 'Hora', '`Hora`', 'DATE_FORMAT(`Hora`, \'%d/%m/%Y %H:%i:%s\')', 134, -1, FALSE, '`Hora`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Hora->FldDefaultErrMsg = $Language->Phrase("IncorrectTime");
		$this->fields['Hora'] = &$this->Hora;

		// Status
		$this->Status = new cField('cap_entrega_sim', 'cap_entrega_sim', 'x_Status', 'Status', '`Status`', '`Status`', 202, -1, FALSE, '`Status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Status'] = &$this->Status;

		// TipoArticulo
		$this->TipoArticulo = new cField('cap_entrega_sim', 'cap_entrega_sim', 'x_TipoArticulo', 'TipoArticulo', '`TipoArticulo`', '`TipoArticulo`', 202, -1, FALSE, '`TipoArticulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['TipoArticulo'] = &$this->TipoArticulo;

		// Id_Empleado_Entrega
		$this->Id_Empleado_Entrega = new cField('cap_entrega_sim', 'cap_entrega_sim', 'x_Id_Empleado_Entrega', 'Id_Empleado_Entrega', '`Id_Empleado_Entrega`', '`Id_Empleado_Entrega`', 3, -1, FALSE, '`Id_Empleado_Entrega`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "cap_entrega_sim_det") {
			$sDetailUrl = $GLOBALS["cap_entrega_sim_det"]->GetListUrl() . "?showmaster=" . $this->TableVar;
	...
	function SqlWhere() { // Where
		$sWhere = "";
		$this->TableFilter = "`Id_Almacen_Entrega`=".Id_Tienda_Actual();
	...
	// Update Table
	var $UpdateTable = "`cap_entrega_sim`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cap_entrega_simlist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("cap_entrega_simview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "cap_entrega_simadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cap_entrega_simedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cap_entrega_simedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cap_entrega_simadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cap_entrega_simadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cap_entrega_simdelete.php", $this->UrlParm());
	}
