...
$cap_inventario_accesorios_update = NULL; // Initialize page object first

class ccap_inventario_accesorios_update extends ccap_inventario_accesorios {
	...
	// Page object name
	var $PageObjName = 'cap_inventario_accesorios_update';
	...
	function Page_Init() {
		...
		if (!$Security->CanEdit()) {
			...
			$this->Page_Terminate("cap_inventario_accesorioslist.php");
		}
	...
	function Page_Main() {
		...
		if (count($this->RecKeys) <= 0)
			$this->Page_Terminate("cap_inventario_accesorioslist.php"); // No records selected, return to list
...
// Create page object
if (!isset($cap_inventario_accesorios_update)) $cap_inventario_accesorios_update = new ccap_inventario_accesorios_update();

// Page init
$cap_inventario_accesorios_update->Page_Init();

// Page main
$cap_inventario_accesorios_update->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var cap_inventario_accesorios_update = new ew_Page("cap_inventario_accesorios_update");
cap_inventario_accesorios_update.PageID = "update"; // Page ID
var EW_PAGE_ID = cap_inventario_accesorios_update.PageID; // For backward compatibility

// Form object
var fcap_inventario_accesoriosupdate = new ew_Form("fcap_inventario_accesoriosupdate");

// Validate form
fcap_inventario_accesoriosupdate.Validate = function(fobj) {
...
fcap_inventario_accesoriosupdate.Form_CustomValidate = 
...
fcap_inventario_accesoriosupdate.ValidateRequired = true;
<?php } else { ?>
fcap_inventario_accesoriosupdate.ValidateRequired = false; 
<?php } ?>
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Update") ?>&nbsp;<?php echo $Language->Phrase("TblTypeVIEW") ?><?php echo $cap_inventario_accesorios->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $cap_inventario_accesorios->getReturnUrl() ?>" id="a_BackToList" class="ewLink"><?php echo $Language->Phrase("BackToList") ?></a></p>
<?php $cap_inventario_accesorios_update->ShowPageHeader(); ?>
<?php
$cap_inventario_accesorios_update->ShowMessage();
?>
<form name="fcap_inventario_accesoriosupdate" id="fcap_inventario_accesoriosupdate" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="cap_inventario_accesorios">
<input type="hidden" name="a_update" id="a_update" value="U">
<?php foreach ($cap_inventario_accesorios_update->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_cap_inventario_accesoriosupdate" class="ewTable ewTableSeparate">
...
<?php if ($cap_inventario_accesorios->Cantidad_Minima->Visible) { // Cantidad_Minima ?>
	<tr id="r_Cantidad_Minima"<?php echo $cap_inventario_accesorios->RowAttributes() ?>>
		<td class="ewCheckbox"<?php echo $cap_inventario_accesorios->Cantidad_Minima->CellAttributes() ?>>
<input type="checkbox" name="u_Cantidad_Minima" id="u_Cantidad_Minima" value="1"<?php echo ($cap_inventario_accesorios->Cantidad_Minima->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
</td>
		<td<?php echo $cap_inventario_accesorios->Cantidad_Minima->CellAttributes() ?>><span id="elh_cap_inventario_accesorios_Cantidad_Minima"><?php echo $cap_inventario_accesorios->Cantidad_Minima->FldCaption() ?></span></td>
		<td<?php echo $cap_inventario_accesorios->Cantidad_Minima->CellAttributes() ?>><span id="el_cap_inventario_accesorios_Cantidad_Minima">
<input type="text" name="x_Cantidad_Minima" id="x_Cantidad_Minima" size="5" maxlength="5" value="<?php echo $cap_inventario_accesorios->Cantidad_Minima->EditValue ?>"<?php echo $cap_inventario_accesorios->Cantidad_Minima->EditAttributes() ?>>
</span><?php echo $cap_inventario_accesorios->Cantidad_Minima->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($cap_inventario_accesorios->Cantidad_Maxima->Visible) { // Cantidad_Maxima ?>
	<tr id="r_Cantidad_Maxima"<?php echo $cap_inventario_accesorios->RowAttributes() ?>>
		<td class="ewCheckbox"<?php echo $cap_inventario_accesorios->Cantidad_Maxima->CellAttributes() ?>>
<input type="checkbox" name="u_Cantidad_Maxima" id="u_Cantidad_Maxima" value="1"<?php echo ($cap_inventario_accesorios->Cantidad_Maxima->MultiUpdate == "1") ? " checked=\"checked\"" : "" ?>>
</td>
		<td<?php echo $cap_inventario_accesorios->Cantidad_Maxima->CellAttributes() ?>><span id="elh_cap_inventario_accesorios_Cantidad_Maxima"><?php echo $cap_inventario_accesorios->Cantidad_Maxima->FldCaption() ?></span></td>
		<td<?php echo $cap_inventario_accesorios->Cantidad_Maxima->CellAttributes() ?>><span id="el_cap_inventario_accesorios_Cantidad_Maxima">
<input type="text" name="x_Cantidad_Maxima" id="x_Cantidad_Maxima" size="5" maxlength="5" value="<?php echo $cap_inventario_accesorios->Cantidad_Maxima->EditValue ?>"<?php echo $cap_inventario_accesorios->Cantidad_Maxima->EditAttributes() ?>>
</span><?php echo $cap_inventario_accesorios->Cantidad_Maxima->CustomMsg ?></td>
	</tr>
<?php } ?>
</table>
</div>
...
<script type="text/javascript">
fcap_inventario_accesoriosupdate.Init();
</script>
<?php
$cap_inventario_accesorios_update->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cap_inventario_accesorios_update->Page_Terminate();
?>
