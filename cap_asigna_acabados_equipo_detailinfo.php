...
$cap_asigna_acabados_equipo_detail = NULL;

//
// Table class for cap_asigna_acabados_equipo_detail
//
class ccap_asigna_acabados_equipo_detail extends cTable {
	var $Id;
	var $Id_Articulo;
	var $Id_Acabado_eq;
	...
	function __construct() {
		...
		$this->TableVar = 'cap_asigna_acabados_equipo_detail';
		$this->TableName = 'cap_asigna_acabados_equipo_detail';
		$this->TableType = 'VIEW';
		...
		// Id
		$this->Id = new cField('cap_asigna_acabados_equipo_detail', 'cap_asigna_acabados_equipo_detail', 'x_Id', 'Id', '`Id`', '`Id`', 3, -1, FALSE, '`Id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id'] = &$this->Id;

		// Id_Articulo
		$this->Id_Articulo = new cField('cap_asigna_acabados_equipo_detail', 'cap_asigna_acabados_equipo_detail', 'x_Id_Articulo', 'Id_Articulo', '`Id_Articulo`', '`Id_Articulo`', 3, -1, FALSE, '`Id_Articulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Articulo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Articulo'] = &$this->Id_Articulo;

		// Id_Acabado_eq
		$this->Id_Acabado_eq = new cField('cap_asigna_acabados_equipo_detail', 'cap_asigna_acabados_equipo_detail', 'x_Id_Acabado_eq', 'Id_Acabado_eq', '`Id_Acabado_eq`', '`Id_Acabado_eq`', 3, -1, FALSE, '`Id_Acabado_eq`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "cap_asigna_acabados_equipo") {
			if ($this->Id_Articulo->getSessionValue() <> "")
				$sMasterFilter .= "`Id_Articulo`=" . ew_QuotedValue($this->Id_Articulo->getSessionValue(), EW_DATATYPE_NUMBER);
			else
				return "";
		}
	...
	function GetDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "cap_asigna_acabados_equipo") {
			if ($this->Id_Articulo->getSessionValue() <> "")
				$sDetailFilter .= "`Id_Articulo`=" . ew_QuotedValue($this->Id_Articulo->getSessionValue(), EW_DATATYPE_NUMBER);
			else
				return "";
		}
	...
	// Master filter
	function SqlMasterFilter_cap_asigna_acabados_equipo() {
		return "`Id_Articulo`=@Id_Articulo@";
	}

	// Detail filter
	function SqlDetailFilter_cap_asigna_acabados_equipo() {
		return "`Id_Articulo`=@Id_Articulo@";
	}

	// Table level SQL
	function SqlFrom() { // From
		return "`cap_asigna_acabados_equipo_detail`";
	}
	...
	// Update Table
	var $UpdateTable = "`cap_asigna_acabados_equipo_detail`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cap_asigna_acabados_equipo_detaillist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("cap_asigna_acabados_equipo_detailview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "cap_asigna_acabados_equipo_detailadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cap_asigna_acabados_equipo_detailedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cap_asigna_acabados_equipo_detailadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cap_asigna_acabados_equipo_detaildelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function Row_Inserted($rsold, &$rsnew) {
		...
		//echo "Row Inserted"
	  echo "insertamos ya";
	  header('Location: cap_asigna_acabados_equipolist.php'); 
	  exit;                              
	  exit;
	}
