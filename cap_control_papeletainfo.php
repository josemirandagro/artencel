...
$cap_control_papeleta = NULL;

//
// Table class for cap_control_papeleta
//
class ccap_control_papeleta extends cTable {
	var $Id_Venta_Eq;
	var $StatusPapeleta;
	var $FechaAviso;
	var $Tipo_Papeleta;
	...
	function __construct() {
		...
		$this->TableVar = 'cap_control_papeleta';
		$this->TableName = 'cap_control_papeleta';
		$this->TableType = 'VIEW';
		...
		// Id_Venta_Eq
		$this->Id_Venta_Eq = new cField('cap_control_papeleta', 'cap_control_papeleta', 'x_Id_Venta_Eq', 'Id_Venta_Eq', '`Id_Venta_Eq`', '`Id_Venta_Eq`', 3, -1, FALSE, '`Id_Venta_Eq`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Venta_Eq->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Venta_Eq'] = &$this->Id_Venta_Eq;

		// StatusPapeleta
		$this->StatusPapeleta = new cField('cap_control_papeleta', 'cap_control_papeleta', 'x_StatusPapeleta', 'StatusPapeleta', '`StatusPapeleta`', '`StatusPapeleta`', 202, -1, FALSE, '`StatusPapeleta`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['StatusPapeleta'] = &$this->StatusPapeleta;

		// FechaAviso
		$this->FechaAviso = new cField('cap_control_papeleta', 'cap_control_papeleta', 'x_FechaAviso', 'FechaAviso', '`FechaAviso`', 'DATE_FORMAT(`FechaAviso`, \'%d/%m/%Y %H:%i:%s\')', 133, 7, FALSE, '`FechaAviso`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->FechaAviso->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['FechaAviso'] = &$this->FechaAviso;

		// Tipo Papeleta
		$this->Tipo_Papeleta = new cField('cap_control_papeleta', 'cap_control_papeleta', 'x_Tipo_Papeleta', 'Tipo Papeleta', '`Tipo Papeleta`', '`Tipo Papeleta`', 202, -1, FALSE, '`Tipo Papeleta`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Tipo Papeleta'] = &$this->Tipo_Papeleta;

		// Num_IMEI
		$this->Num_IMEI = new cField('cap_control_papeleta', 'cap_control_papeleta', 'x_Num_IMEI', 'Num_IMEI', '`Num_IMEI`', '`Num_IMEI`', 200, -1, FALSE, '`Num_IMEI`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Num_IMEI'] = &$this->Num_IMEI;

		// Num_CEL
		$this->Num_CEL = new cField('cap_control_papeleta', 'cap_control_papeleta', 'x_Num_CEL', 'Num_CEL', '`Num_CEL`', '`Num_CEL`', 200, -1, FALSE, '`Num_CEL`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Num_CEL'] = &$this->Num_CEL;

		// FolioImpresoPapeleta
		$this->FolioImpresoPapeleta = new cField('cap_control_papeleta', 'cap_control_papeleta', 'x_FolioImpresoPapeleta', 'FolioImpresoPapeleta', '`FolioImpresoPapeleta`', '`FolioImpresoPapeleta`', 200, -1, FALSE, '`FolioImpresoPapeleta`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`cap_control_papeleta`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cap_control_papeletalist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("cap_control_papeletaview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "cap_control_papeletaadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cap_control_papeletaedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cap_control_papeletaadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cap_control_papeletadelete.php", $this->UrlParm());
	}
