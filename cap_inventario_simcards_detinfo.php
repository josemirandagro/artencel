...
$cap_inventario_simcards_det = NULL;

//
// Table class for cap_inventario_simcards_det
//
class ccap_inventario_simcards_det extends cTable {
	var $Id_Almacen;
	var $Id_Articulo;
	var $Articulo;
	var $Num_ICCID;
	...
	function __construct() {
		...
		$this->TableVar = 'cap_inventario_simcards_det';
		$this->TableName = 'cap_inventario_simcards_det';
		$this->TableType = 'VIEW';
		...
		// Id_Almacen
		$this->Id_Almacen = new cField('cap_inventario_simcards_det', 'cap_inventario_simcards_det', 'x_Id_Almacen', 'Id_Almacen', '`Id_Almacen`', '`Id_Almacen`', 3, -1, FALSE, '`Id_Almacen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Almacen->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Almacen'] = &$this->Id_Almacen;

		// Id_Articulo
		$this->Id_Articulo = new cField('cap_inventario_simcards_det', 'cap_inventario_simcards_det', 'x_Id_Articulo', 'Id_Articulo', '`Id_Articulo`', '`Id_Articulo`', 3, -1, FALSE, '`Id_Articulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Articulo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Articulo'] = &$this->Id_Articulo;

		// Articulo
		$this->Articulo = new cField('cap_inventario_simcards_det', 'cap_inventario_simcards_det', 'x_Articulo', 'Articulo', '`Articulo`', '`Articulo`', 200, -1, FALSE, '`Articulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Articulo'] = &$this->Articulo;

		// Num_ICCID
		$this->Num_ICCID = new cField('cap_inventario_simcards_det', 'cap_inventario_simcards_det', 'x_Num_ICCID', 'Num_ICCID', '`Num_ICCID`', '`Num_ICCID`', 200, -1, FALSE, '`Num_ICCID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Num_ICCID'] = &$this->Num_ICCID;

		// Num_CEL
		$this->Num_CEL = new cField('cap_inventario_simcards_det', 'cap_inventario_simcards_det', 'x_Num_CEL', 'Num_CEL', '`Num_CEL`', '`Num_CEL`', 200, -1, FALSE, '`Num_CEL`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "cap_inventario_simcards") {
	...
	// Master filter
	function SqlMasterFilter_cap_inventario_simcards() {
		return "`Id_Almacen`=@Id_Almacen@ AND `Id_Articulo`=@Id_Articulo@";
	}

	// Detail filter
	function SqlDetailFilter_cap_inventario_simcards() {
		return "`Id_Almacen`=@Id_Almacen@ AND `Id_Articulo`=@Id_Articulo@";
	}

	// Table level SQL
	function SqlFrom() { // From
		return "`cap_inventario_simcards_det`";
	}
	...
	// Update Table
	var $UpdateTable = "`cap_inventario_simcards_det`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cap_inventario_simcards_detlist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("cap_inventario_simcards_detview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "cap_inventario_simcards_detadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cap_inventario_simcards_detedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cap_inventario_simcards_detadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cap_inventario_simcards_detdelete.php", $this->UrlParm());
	}
