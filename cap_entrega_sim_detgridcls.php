...
$cap_entrega_sim_det_grid = NULL; // Initialize page object first

class ccap_entrega_sim_det_grid extends ccap_entrega_sim_det {
	...
	// Page object name
	var $PageObjName = 'cap_entrega_sim_det_grid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["cap_entrega_sim_det"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "cap_entrega_sim") {
			...
			if ($GLOBALS["cap_entrega_sim"]->EventCancelled) $this->EventCancelled = TRUE;
		}
