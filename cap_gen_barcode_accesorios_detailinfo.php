...
$cap_gen_barcode_accesorios_detail = NULL;

//
// Table class for cap_gen_barcode_accesorios_detail
//
class ccap_gen_barcode_accesorios_detail extends cTable {
	var $Id_Compra;
	var $Id_Compra_Det;
	var $Articulo;
	var $Codigo;
	...
	function __construct() {
		...
		$this->TableVar = 'cap_gen_barcode_accesorios_detail';
		$this->TableName = 'cap_gen_barcode_accesorios_detail';
		$this->TableType = 'VIEW';
		...
		// Id_Compra
		$this->Id_Compra = new cField('cap_gen_barcode_accesorios_detail', 'cap_gen_barcode_accesorios_detail', 'x_Id_Compra', 'Id_Compra', '`Id_Compra`', '`Id_Compra`', 3, -1, FALSE, '`Id_Compra`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Compra->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Compra'] = &$this->Id_Compra;

		// Id_Compra_Det
		$this->Id_Compra_Det = new cField('cap_gen_barcode_accesorios_detail', 'cap_gen_barcode_accesorios_detail', 'x_Id_Compra_Det', 'Id_Compra_Det', '`Id_Compra_Det`', '`Id_Compra_Det`', 3, -1, FALSE, '`Id_Compra_Det`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Compra_Det->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Compra_Det'] = &$this->Id_Compra_Det;

		// Articulo
		$this->Articulo = new cField('cap_gen_barcode_accesorios_detail', 'cap_gen_barcode_accesorios_detail', 'x_Articulo', 'Articulo', '`Articulo`', '`Articulo`', 200, -1, FALSE, '`Articulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Articulo'] = &$this->Articulo;

		// Codigo
		$this->Codigo = new cField('cap_gen_barcode_accesorios_detail', 'cap_gen_barcode_accesorios_detail', 'x_Codigo', 'Codigo', '`Codigo`', '`Codigo`', 200, -1, FALSE, '`Codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Codigo'] = &$this->Codigo;

		// CantRecibida
		$this->CantRecibida = new cField('cap_gen_barcode_accesorios_detail', 'cap_gen_barcode_accesorios_detail', 'x_CantRecibida', 'CantRecibida', '`CantRecibida`', '`CantRecibida`', 19, -1, FALSE, '`CantRecibida`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "cap_gen_barcode_accesorios") {
	...
	// Master filter
	function SqlMasterFilter_cap_gen_barcode_accesorios() {
		return "`Id_Compra`=@Id_Compra@";
	}

	// Detail filter
	function SqlDetailFilter_cap_gen_barcode_accesorios() {
		return "`Id_Compra`=@Id_Compra@";
	}

	// Table level SQL
	function SqlFrom() { // From
		return "`cap_gen_barcode_accesorios_detail`";
	}
	...
	// Update Table
	var $UpdateTable = "`cap_gen_barcode_accesorios_detail`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cap_gen_barcode_accesorios_detaillist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("cap_gen_barcode_accesorios_detailview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "cap_gen_barcode_accesorios_detailadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cap_gen_barcode_accesorios_detailedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cap_gen_barcode_accesorios_detailadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cap_gen_barcode_accesorios_detaildelete.php", $this->UrlParm());
	}
