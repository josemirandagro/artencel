...
$cap_cliente_nota_venta = NULL;

//
// Table class for cap_cliente_nota_venta
//
class ccap_cliente_nota_venta extends cTable {
	var $Id_Cliente;
	var $Nombre_Completo;
	var $Domicilio;
	var $Poblacion;
	...
	function __construct() {
		...
		$this->TableVar = 'cap_cliente_nota_venta';
		$this->TableName = 'cap_cliente_nota_venta';
		$this->TableType = 'VIEW';
		...
		// Id_Cliente
		$this->Id_Cliente = new cField('cap_cliente_nota_venta', 'cap_cliente_nota_venta', 'x_Id_Cliente', 'Id_Cliente', '`Id_Cliente`', '`Id_Cliente`', 3, -1, FALSE, '`Id_Cliente`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Cliente->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Cliente'] = &$this->Id_Cliente;

		// Nombre_Completo
		$this->Nombre_Completo = new cField('cap_cliente_nota_venta', 'cap_cliente_nota_venta', 'x_Nombre_Completo', 'Nombre_Completo', '`Nombre_Completo`', '`Nombre_Completo`', 200, -1, FALSE, '`Nombre_Completo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Nombre_Completo'] = &$this->Nombre_Completo;

		// Domicilio
		$this->Domicilio = new cField('cap_cliente_nota_venta', 'cap_cliente_nota_venta', 'x_Domicilio', 'Domicilio', '`Domicilio`', '`Domicilio`', 200, -1, FALSE, '`Domicilio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Domicilio'] = &$this->Domicilio;

		// Poblacion
		$this->Poblacion = new cField('cap_cliente_nota_venta', 'cap_cliente_nota_venta', 'x_Poblacion', 'Poblacion', '`Poblacion`', '`Poblacion`', 200, -1, FALSE, '`Poblacion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Poblacion'] = &$this->Poblacion;

		// Tel_Particular
		$this->Tel_Particular = new cField('cap_cliente_nota_venta', 'cap_cliente_nota_venta', 'x_Tel_Particular', 'Tel_Particular', '`Tel_Particular`', '`Tel_Particular`', 200, -1, FALSE, '`Tel_Particular`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Tel_Particular'] = &$this->Tel_Particular;

		// Id_Estado
		$this->Id_Estado = new cField('cap_cliente_nota_venta', 'cap_cliente_nota_venta', 'x_Id_Estado', 'Id_Estado', '`Id_Estado`', '`Id_Estado`', 3, -1, FALSE, '`Id_Estado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`cap_cliente_nota_venta`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cap_cliente_nota_ventalist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("cap_cliente_nota_ventaview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "cap_cliente_nota_ventaadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cap_cliente_nota_ventaedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cap_cliente_nota_ventaadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cap_cliente_nota_ventadelete.php", $this->UrlParm());
	}
