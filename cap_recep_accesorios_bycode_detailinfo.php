...
$cap_recep_accesorios_bycode_detail = NULL;

//
// Table class for cap_recep_accesorios_bycode_detail
//
class ccap_recep_accesorios_bycode_detail extends cTable {
	var $Id_Compra_Det;
	var $Id_Compra;
	var $BarCode_Externo;
	var $Id_Articulo;
	...
	function __construct() {
		...
		$this->TableVar = 'cap_recep_accesorios_bycode_detail';
		$this->TableName = 'cap_recep_accesorios_bycode_detail';
		$this->TableType = 'VIEW';
		...
		// Id_Compra_Det
		$this->Id_Compra_Det = new cField('cap_recep_accesorios_bycode_detail', 'cap_recep_accesorios_bycode_detail', 'x_Id_Compra_Det', 'Id_Compra_Det', '`Id_Compra_Det`', '`Id_Compra_Det`', 3, -1, FALSE, '`Id_Compra_Det`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Compra_Det->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Compra_Det'] = &$this->Id_Compra_Det;

		// Id_Compra
		$this->Id_Compra = new cField('cap_recep_accesorios_bycode_detail', 'cap_recep_accesorios_bycode_detail', 'x_Id_Compra', 'Id_Compra', '`Id_Compra`', '`Id_Compra`', 3, -1, FALSE, '`Id_Compra`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Compra->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Compra'] = &$this->Id_Compra;

		// BarCode_Externo
		$this->BarCode_Externo = new cField('cap_recep_accesorios_bycode_detail', 'cap_recep_accesorios_bycode_detail', 'x_BarCode_Externo', 'BarCode_Externo', '`BarCode_Externo`', '`BarCode_Externo`', 200, -1, FALSE, '`BarCode_Externo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['BarCode_Externo'] = &$this->BarCode_Externo;

		// Id_Articulo
		$this->Id_Articulo = new cField('cap_recep_accesorios_bycode_detail', 'cap_recep_accesorios_bycode_detail', 'x_Id_Articulo', 'Id_Articulo', '`Id_Articulo`', '`Id_Articulo`', 3, -1, FALSE, '`EV__Id_Articulo`', TRUE, TRUE, FALSE, 'FORMATTED TEXT');
		$this->Id_Articulo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Articulo'] = &$this->Id_Articulo;

		// CantRecibida
		$this->CantRecibida = new cField('cap_recep_accesorios_bycode_detail', 'cap_recep_accesorios_bycode_detail', 'x_CantRecibida', 'CantRecibida', '`CantRecibida`', '`CantRecibida`', 19, -1, FALSE, '`CantRecibida`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->CantRecibida->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['CantRecibida'] = &$this->CantRecibida;

		// Precio_Unitario
		$this->Precio_Unitario = new cField('cap_recep_accesorios_bycode_detail', 'cap_recep_accesorios_bycode_detail', 'x_Precio_Unitario', 'Precio_Unitario', '`Precio_Unitario`', '`Precio_Unitario`', 131, -1, FALSE, '`Precio_Unitario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Precio_Unitario->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Precio_Unitario'] = &$this->Precio_Unitario;

		// MontoTotal
		$this->MontoTotal = new cField('cap_recep_accesorios_bycode_detail', 'cap_recep_accesorios_bycode_detail', 'x_MontoTotal', 'MontoTotal', '`MontoTotal`', '`MontoTotal`', 131, -1, FALSE, '`MontoTotal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->MontoTotal->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['MontoTotal'] = &$this->MontoTotal;

		// TipoArticulo
		$this->TipoArticulo = new cField('cap_recep_accesorios_bycode_detail', 'cap_recep_accesorios_bycode_detail', 'x_TipoArticulo', 'TipoArticulo', '`TipoArticulo`', '`TipoArticulo`', 202, -1, FALSE, '`TipoArticulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "cap_recep_accesorios_bycode") {
	...
	// Master filter
	function SqlMasterFilter_cap_recep_accesorios_bycode() {
		return "`Id_Compra`=@Id_Compra@";
	}

	// Detail filter
	function SqlDetailFilter_cap_recep_accesorios_bycode() {
		return "`Id_Compra`=@Id_Compra@";
	}

	// Table level SQL
	function SqlFrom() { // From
		return "`cap_recep_accesorios_bycode_detail`";
	}
	...
	function SqlSelectList() { // Select for List page
		return "SELECT * FROM (" .
			"SELECT *, (SELECT `Articulo` FROM `ca_articulos` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`Id_Articulo` = `cap_recep_accesorios_bycode_detail`.`Id_Articulo` LIMIT 1) AS `EV__Id_Articulo` FROM `cap_recep_accesorios_bycode_detail`" .
			") `EW_TMP_TABLE`";
	}
	...
	// Update Table
	var $UpdateTable = "`cap_recep_accesorios_bycode_detail`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cap_recep_accesorios_bycode_detaillist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("cap_recep_accesorios_bycode_detailview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "cap_recep_accesorios_bycode_detailadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cap_recep_accesorios_bycode_detailedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cap_recep_accesorios_bycode_detailadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cap_recep_accesorios_bycode_detaildelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) {
			...
			$Doc->ExportAggregate($this->BarCode_Externo, '');
