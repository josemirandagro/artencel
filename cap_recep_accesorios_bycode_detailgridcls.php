...
$cap_recep_accesorios_bycode_detail_grid = NULL; // Initialize page object first

class ccap_recep_accesorios_bycode_detail_grid extends ccap_recep_accesorios_bycode_detail {
	...
	// Page object name
	var $PageObjName = 'cap_recep_accesorios_bycode_detail_grid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["cap_recep_accesorios_bycode_detail"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_BarCode_Externo") && $objForm->HasValue("o_BarCode_Externo") && $this->BarCode_Externo->CurrentValue <> $this->BarCode_Externo->OldValue)
			return FALSE;
	...
	function LoadFormValues() {
		...
		$this->BarCode_Externo->setOldValue($objForm->GetValue("o_BarCode_Externo"));
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "cap_recep_accesorios_bycode") {
			...
			if ($GLOBALS["cap_recep_accesorios_bycode"]->EventCancelled) $this->EventCancelled = TRUE;
		}
