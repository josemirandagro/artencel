...
$cap_entrega_accesorio_det_grid = NULL; // Initialize page object first

class ccap_entrega_accesorio_det_grid extends ccap_entrega_accesorio_det {
	...
	// Page object name
	var $PageObjName = 'cap_entrega_accesorio_det_grid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["cap_entrega_accesorio_det"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "cap_entrega_accesorio") {
			...
			if ($GLOBALS["cap_entrega_accesorio"]->EventCancelled) $this->EventCancelled = TRUE;
		}
