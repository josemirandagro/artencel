...
$cap_inventario_simcards = NULL;

//
// Table class for cap_inventario_simcards
//
class ccap_inventario_simcards extends cTable {
	var $Id_Tel_SIM;
	var $Id_Almacen;
	var $Id_Articulo;
	var $Num_ICCID;
	...
	function __construct() {
		...
		$this->TableVar = 'cap_inventario_simcards';
		$this->TableName = 'cap_inventario_simcards';
		$this->TableType = 'VIEW';
		...
		// Id_Tel_SIM
		$this->Id_Tel_SIM = new cField('cap_inventario_simcards', 'cap_inventario_simcards', 'x_Id_Tel_SIM', 'Id_Tel_SIM', '`Id_Tel_SIM`', '`Id_Tel_SIM`', 19, -1, FALSE, '`Id_Tel_SIM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Tel_SIM->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Tel_SIM'] = &$this->Id_Tel_SIM;

		// Id_Almacen
		$this->Id_Almacen = new cField('cap_inventario_simcards', 'cap_inventario_simcards', 'x_Id_Almacen', 'Id_Almacen', '`Id_Almacen`', '`Id_Almacen`', 3, -1, FALSE, '`Id_Almacen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Almacen->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Almacen'] = &$this->Id_Almacen;

		// Id_Articulo
		$this->Id_Articulo = new cField('cap_inventario_simcards', 'cap_inventario_simcards', 'x_Id_Articulo', 'Id_Articulo', '`Id_Articulo`', '`Id_Articulo`', 3, -1, FALSE, '`Id_Articulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Articulo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Articulo'] = &$this->Id_Articulo;

		// Num_ICCID
		$this->Num_ICCID = new cField('cap_inventario_simcards', 'cap_inventario_simcards', 'x_Num_ICCID', 'Num_ICCID', '`Num_ICCID`', '`Num_ICCID`', 200, -1, FALSE, '`Num_ICCID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Num_ICCID'] = &$this->Num_ICCID;

		// Num_CEL
		$this->Num_CEL = new cField('cap_inventario_simcards', 'cap_inventario_simcards', 'x_Num_CEL', 'Num_CEL', '`Num_CEL`', '`Num_CEL`', 200, -1, FALSE, '`Num_CEL`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Num_CEL'] = &$this->Num_CEL;

		// Status
		$this->Status = new cField('cap_inventario_simcards', 'cap_inventario_simcards', 'x_Status', 'Status', '`Status`', '`Status`', 202, -1, FALSE, '`Status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlFrom() { // From
		return "`cap_inventario_simcards`";
	}
	...
	function SqlOrderBy() { // Order By
		return "`Id_Almacen` ASC,`Id_Articulo` ASC";
	}
	...
	// Update Table
	var $UpdateTable = "`cap_inventario_simcards`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cap_inventario_simcardslist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("cap_inventario_simcardsview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "cap_inventario_simcardsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cap_inventario_simcardsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cap_inventario_simcardsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cap_inventario_simcardsdelete.php", $this->UrlParm());
	}
