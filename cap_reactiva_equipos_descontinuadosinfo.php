...
$cap_reactiva_equipos_descontinuados = NULL;

//
// Table class for cap_reactiva_equipos_descontinuados
//
class ccap_reactiva_equipos_descontinuados extends cTable {
	var $Id_Articulo;
	var $Status;
	var $Articulo;
	var $Codigo;
	...
	function __construct() {
		...
		$this->TableVar = 'cap_reactiva_equipos_descontinuados';
		$this->TableName = 'cap_reactiva_equipos_descontinuados';
		$this->TableType = 'VIEW';
		...
		// Id_Articulo
		$this->Id_Articulo = new cField('cap_reactiva_equipos_descontinuados', 'cap_reactiva_equipos_descontinuados', 'x_Id_Articulo', 'Id_Articulo', '`Id_Articulo`', '`Id_Articulo`', 3, -1, FALSE, '`Id_Articulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Articulo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Articulo'] = &$this->Id_Articulo;

		// Status
		$this->Status = new cField('cap_reactiva_equipos_descontinuados', 'cap_reactiva_equipos_descontinuados', 'x_Status', 'Status', '`Status`', '`Status`', 202, -1, FALSE, '`Status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Status'] = &$this->Status;

		// Articulo
		$this->Articulo = new cField('cap_reactiva_equipos_descontinuados', 'cap_reactiva_equipos_descontinuados', 'x_Articulo', 'Articulo', '`Articulo`', '`Articulo`', 200, -1, FALSE, '`Articulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Articulo'] = &$this->Articulo;

		// Codigo
		$this->Codigo = new cField('cap_reactiva_equipos_descontinuados', 'cap_reactiva_equipos_descontinuados', 'x_Codigo', 'Codigo', '`Codigo`', '`Codigo`', 200, -1, FALSE, '`Codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Codigo'] = &$this->Codigo;

		// COD_Marca_eq
		$this->COD_Marca_eq = new cField('cap_reactiva_equipos_descontinuados', 'cap_reactiva_equipos_descontinuados', 'x_COD_Marca_eq', 'COD_Marca_eq', '`COD_Marca_eq`', '`COD_Marca_eq`', 200, -1, FALSE, '`COD_Marca_eq`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['COD_Marca_eq'] = &$this->COD_Marca_eq;

		// COD_Modelo_eq
		$this->COD_Modelo_eq = new cField('cap_reactiva_equipos_descontinuados', 'cap_reactiva_equipos_descontinuados', 'x_COD_Modelo_eq', 'COD_Modelo_eq', '`COD_Modelo_eq`', '`COD_Modelo_eq`', 200, -1, FALSE, '`COD_Modelo_eq`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['COD_Modelo_eq'] = &$this->COD_Modelo_eq;

		// COD_Compania_eq
		$this->COD_Compania_eq = new cField('cap_reactiva_equipos_descontinuados', 'cap_reactiva_equipos_descontinuados', 'x_COD_Compania_eq', 'COD_Compania_eq', '`COD_Compania_eq`', '`COD_Compania_eq`', 200, -1, FALSE, '`COD_Compania_eq`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlFrom() { // From
		return "`cap_reactiva_equipos_descontinuados`";
	}
	...
	// Update Table
	var $UpdateTable = "`cap_reactiva_equipos_descontinuados`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cap_reactiva_equipos_descontinuadoslist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("cap_reactiva_equipos_descontinuadosview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "cap_reactiva_equipos_descontinuadosadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cap_reactiva_equipos_descontinuadosedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cap_reactiva_equipos_descontinuadosadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cap_reactiva_equipos_descontinuadosdelete.php", $this->UrlParm());
	}
