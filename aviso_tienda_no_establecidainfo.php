...
$aviso_tienda_no_establecida = NULL;

//
// Table class for aviso_tienda_no_establecida
//
class caviso_tienda_no_establecida extends cTable {
	var $Nombre;
	var $Id_Nivel;
	var $Usuario;
	var $IdEmpleado;
	...
	function __construct() {
		...
		$this->TableVar = 'aviso_tienda_no_establecida';
		$this->TableName = 'aviso_tienda_no_establecida';
		$this->TableType = 'VIEW';
		...
		// Nombre
		$this->Nombre = new cField('aviso_tienda_no_establecida', 'aviso_tienda_no_establecida', 'x_Nombre', 'Nombre', '`Nombre`', '`Nombre`', 200, -1, FALSE, '`Nombre`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Nombre'] = &$this->Nombre;

		// Id_Nivel
		$this->Id_Nivel = new cField('aviso_tienda_no_establecida', 'aviso_tienda_no_establecida', 'x_Id_Nivel', 'Id_Nivel', '`Id_Nivel`', '`Id_Nivel`', 3, -1, FALSE, '`Id_Nivel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Nivel->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Nivel'] = &$this->Id_Nivel;

		// Usuario
		$this->Usuario = new cField('aviso_tienda_no_establecida', 'aviso_tienda_no_establecida', 'x_Usuario', 'Usuario', '`Usuario`', '`Usuario`', 200, -1, FALSE, '`Usuario`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Usuario'] = &$this->Usuario;

		// IdEmpleado
		$this->IdEmpleado = new cField('aviso_tienda_no_establecida', 'aviso_tienda_no_establecida', 'x_IdEmpleado', 'IdEmpleado', '`IdEmpleado`', '`IdEmpleado`', 3, -1, FALSE, '`IdEmpleado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlFrom() { // From
		return "`aviso_tienda_no_establecida`";
	}
	...
	function SqlWhere() { // Where
		$sWhere = "";
		$this->TableFilter = "`IdEmpleado`=" .CurrentUserID();
	...
	// Update Table
	var $UpdateTable = "`aviso_tienda_no_establecida`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "aviso_tienda_no_establecidalist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("aviso_tienda_no_establecidaview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "aviso_tienda_no_establecidaadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("aviso_tienda_no_establecidaedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("aviso_tienda_no_establecidaadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("aviso_tienda_no_establecidadelete.php", $this->UrlParm());
	}
