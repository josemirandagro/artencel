...
$cap_control_papeleta_revisar = NULL;

//
// Table class for cap_control_papeleta_revisar
//
class ccap_control_papeleta_revisar extends cTable {
	var $Id_Venta_Eq;
	var $Num_IMEI;
	var $Num_CEL;
	...
	function __construct() {
		...
		$this->TableVar = 'cap_control_papeleta_revisar';
		$this->TableName = 'cap_control_papeleta_revisar';
		$this->TableType = 'VIEW';
		...
		// Id_Venta_Eq
		$this->Id_Venta_Eq = new cField('cap_control_papeleta_revisar', 'cap_control_papeleta_revisar', 'x_Id_Venta_Eq', 'Id_Venta_Eq', '`Id_Venta_Eq`', '`Id_Venta_Eq`', 3, -1, FALSE, '`Id_Venta_Eq`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Venta_Eq->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Venta_Eq'] = &$this->Id_Venta_Eq;

		// Num_IMEI
		$this->Num_IMEI = new cField('cap_control_papeleta_revisar', 'cap_control_papeleta_revisar', 'x_Num_IMEI', 'Num_IMEI', '`Num_IMEI`', '`Num_IMEI`', 200, -1, FALSE, '`Num_IMEI`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Num_IMEI'] = &$this->Num_IMEI;

		// Num_CEL
		$this->Num_CEL = new cField('cap_control_papeleta_revisar', 'cap_control_papeleta_revisar', 'x_Num_CEL', 'Num_CEL', '`Num_CEL`', '`Num_CEL`', 200, -1, FALSE, '`Num_CEL`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Num_CEL'] = &$this->Num_CEL;

		// FolioImpresoPapeleta
		$this->FolioImpresoPapeleta = new cField('cap_control_papeleta_revisar', 'cap_control_papeleta_revisar', 'x_FolioImpresoPapeleta', 'FolioImpresoPapeleta', '`FolioImpresoPapeleta`', '`FolioImpresoPapeleta`', 200, -1, FALSE, '`FolioImpresoPapeleta`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['FolioImpresoPapeleta'] = &$this->FolioImpresoPapeleta;

		// StatusPapeleta
		$this->StatusPapeleta = new cField('cap_control_papeleta_revisar', 'cap_control_papeleta_revisar', 'x_StatusPapeleta', 'StatusPapeleta', '`StatusPapeleta`', '`StatusPapeleta`', 202, -1, FALSE, '`StatusPapeleta`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['StatusPapeleta'] = &$this->StatusPapeleta;

		// FechaAviso
		$this->FechaAviso = new cField('cap_control_papeleta_revisar', 'cap_control_papeleta_revisar', 'x_FechaAviso', 'FechaAviso', '`FechaAviso`', 'DATE_FORMAT(`FechaAviso`, \'%d/%m/%Y %H:%i:%s\')', 133, 7, FALSE, '`FechaAviso`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->FechaAviso->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['FechaAviso'] = &$this->FechaAviso;

		// Tipo Papeleta
		$this->Tipo_Papeleta = new cField('cap_control_papeleta_revisar', 'cap_control_papeleta_revisar', 'x_Tipo_Papeleta', 'Tipo Papeleta', '`Tipo Papeleta`', '`Tipo Papeleta`', 202, -1, FALSE, '`Tipo Papeleta`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlFrom() { // From
		return "`cap_control_papeleta_revisar`";
	}
	...
	// Update Table
	var $UpdateTable = "`cap_control_papeleta_revisar`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cap_control_papeleta_revisarlist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("cap_control_papeleta_revisarview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "cap_control_papeleta_revisaradd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cap_control_papeleta_revisaredit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cap_control_papeleta_revisaradd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cap_control_papeleta_revisardelete.php", $this->UrlParm());
	}
