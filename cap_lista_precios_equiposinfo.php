...
$cap_lista_precios_equipos = NULL;

//
// Table class for cap_lista_precios_equipos
//
class ccap_lista_precios_equipos extends cTable {
	var $Id_Articulo;
	var $COD_Marca_eq;
	var $COD_Modelo_eq;
	var $COD_Compania_eq;
	...
	function __construct() {
		...
		$this->TableVar = 'cap_lista_precios_equipos';
		$this->TableName = 'cap_lista_precios_equipos';
		$this->TableType = 'VIEW';
		...
		// Id_Articulo
		$this->Id_Articulo = new cField('cap_lista_precios_equipos', 'cap_lista_precios_equipos', 'x_Id_Articulo', 'Id_Articulo', '`Id_Articulo`', '`Id_Articulo`', 3, -1, FALSE, '`Id_Articulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Articulo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Articulo'] = &$this->Id_Articulo;

		// COD_Marca_eq
		$this->COD_Marca_eq = new cField('cap_lista_precios_equipos', 'cap_lista_precios_equipos', 'x_COD_Marca_eq', 'COD_Marca_eq', '`COD_Marca_eq`', '`COD_Marca_eq`', 200, -1, FALSE, '`EV__COD_Marca_eq`', TRUE, TRUE, FALSE, 'FORMATTED TEXT');
		$this->fields['COD_Marca_eq'] = &$this->COD_Marca_eq;

		// COD_Modelo_eq
		$this->COD_Modelo_eq = new cField('cap_lista_precios_equipos', 'cap_lista_precios_equipos', 'x_COD_Modelo_eq', 'COD_Modelo_eq', '`COD_Modelo_eq`', '`COD_Modelo_eq`', 200, -1, FALSE, '`EV__COD_Modelo_eq`', TRUE, TRUE, FALSE, 'FORMATTED TEXT');
		$this->fields['COD_Modelo_eq'] = &$this->COD_Modelo_eq;

		// COD_Compania_eq
		$this->COD_Compania_eq = new cField('cap_lista_precios_equipos', 'cap_lista_precios_equipos', 'x_COD_Compania_eq', 'COD_Compania_eq', '`COD_Compania_eq`', '`COD_Compania_eq`', 200, -1, FALSE, '`COD_Compania_eq`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['COD_Compania_eq'] = &$this->COD_Compania_eq;

		// Articulo
		$this->Articulo = new cField('cap_lista_precios_equipos', 'cap_lista_precios_equipos', 'x_Articulo', 'Articulo', '`Articulo`', '`Articulo`', 200, -1, FALSE, '`Articulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Articulo'] = &$this->Articulo;

		// Codigo
		$this->Codigo = new cField('cap_lista_precios_equipos', 'cap_lista_precios_equipos', 'x_Codigo', 'Codigo', '`Codigo`', '`Codigo`', 200, -1, FALSE, '`Codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Codigo'] = &$this->Codigo;

		// Precio_compra
		$this->Precio_compra = new cField('cap_lista_precios_equipos', 'cap_lista_precios_equipos', 'x_Precio_compra', 'Precio_compra', '`Precio_compra`', '`Precio_compra`', 131, -1, FALSE, '`Precio_compra`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Precio_compra->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Precio_compra'] = &$this->Precio_compra;

		// Descuento_Sin_Chip
		$this->Descuento_Sin_Chip = new cField('cap_lista_precios_equipos', 'cap_lista_precios_equipos', 'x_Descuento_Sin_Chip', 'Descuento_Sin_Chip', '`Descuento_Sin_Chip`', '`Descuento_Sin_Chip`', 131, -1, FALSE, '`Descuento_Sin_Chip`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Descuento_Sin_Chip->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Descuento_Sin_Chip'] = &$this->Descuento_Sin_Chip;

		// Precio_lista_venta_publico_1
		$this->Precio_lista_venta_publico_1 = new cField('cap_lista_precios_equipos', 'cap_lista_precios_equipos', 'x_Precio_lista_venta_publico_1', 'Precio_lista_venta_publico_1', '`Precio_lista_venta_publico_1`', '`Precio_lista_venta_publico_1`', 131, -1, FALSE, '`Precio_lista_venta_publico_1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Precio_lista_venta_publico_2 = new cField('cap_lista_precios_equipos', 'cap_lista_precios_equipos', 'x_Precio_lista_venta_publico_2', 'Precio_lista_venta_publico_2', '`Precio_lista_venta_publico_2`', '`Precio_lista_venta_publico_2`', 131, -1, FALSE, '`Precio_lista_venta_publico_2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Precio_lista_venta_publico_3 = new cField('cap_lista_precios_equipos', 'cap_lista_precios_equipos', 'x_Precio_lista_venta_publico_3', 'Precio_lista_venta_publico_3', '`Precio_lista_venta_publico_3`', '`Precio_lista_venta_publico_3`', 131, -1, FALSE, '`Precio_lista_venta_publico_3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Precio_lista_venta_medio_mayoreo = new cField('cap_lista_precios_equipos', 'cap_lista_precios_equipos', 'x_Precio_lista_venta_medio_mayoreo', 'Precio_lista_venta_medio_mayoreo', '`Precio_lista_venta_medio_mayoreo`', '`Precio_lista_venta_medio_mayoreo`', 131, -1, FALSE, '`Precio_lista_venta_medio_mayoreo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Precio_lista_venta_mayoreo = new cField('cap_lista_precios_equipos', 'cap_lista_precios_equipos', 'x_Precio_lista_venta_mayoreo', 'Precio_lista_venta_mayoreo', '`Precio_lista_venta_mayoreo`', '`Precio_lista_venta_mayoreo`', 131, -1, FALSE, '`Precio_lista_venta_mayoreo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlFrom() { // From
		return "`cap_lista_precios_equipos`";
	}
	...
	function SqlSelectList() { // Select for List page
		return "SELECT * FROM (" .
			"SELECT *, (SELECT DISTINCT `Marca_eq` FROM `aux_sel_equipos` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`COD_Marca_eq` = `cap_lista_precios_equipos`.`COD_Marca_eq` LIMIT 1) AS `EV__COD_Marca_eq`, (SELECT `COD_Modelo_eq` FROM `aux_sel_equipos` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`COD_Modelo_eq` = `cap_lista_precios_equipos`.`COD_Modelo_eq` LIMIT 1) AS `EV__COD_Modelo_eq` FROM `cap_lista_precios_equipos`" .
			") `EW_TMP_TABLE`";
	}
	...
	function SqlOrderBy() { // Order By
		return "`COD_Marca_eq` ASC,`COD_Modelo_eq` ASC";
	}
	...
	function UseVirtualFields() {
		...
		if (strpos($sOrderBy, " " . $this->COD_Marca_eq->FldVirtualExpression . " ") !== FALSE)
			return TRUE;
		if ($this->BasicSearch->getKeyword() <> "")
			return TRUE;
		if (strpos($sOrderBy, " " . $this->COD_Modelo_eq->FldVirtualExpression . " ") !== FALSE)
			return TRUE;
		return FALSE;
	}
	...
	// Update Table
	var $UpdateTable = "`cap_lista_precios_equipos`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cap_lista_precios_equiposlist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("cap_lista_precios_equiposview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "cap_lista_precios_equiposadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cap_lista_precios_equiposedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cap_lista_precios_equiposadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cap_lista_precios_equiposdelete.php", $this->UrlParm());
	}
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->Descuento_Sin_Chip->Exportable) $Doc->ExportCaption($this->Descuento_Sin_Chip);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->Descuento_Sin_Chip->Exportable) $Doc->ExportField($this->Descuento_Sin_Chip);
