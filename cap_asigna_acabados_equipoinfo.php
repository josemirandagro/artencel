...
$cap_asigna_acabados_equipo = NULL;

//
// Table class for cap_asigna_acabados_equipo
//
class ccap_asigna_acabados_equipo extends cTable {
	var $Id_Articulo;
	var $COD_Marca_eq;
	var $Articulo;
	var $Codigo;
	...
	function __construct() {
		...
		$this->TableVar = 'cap_asigna_acabados_equipo';
		$this->TableName = 'cap_asigna_acabados_equipo';
		$this->TableType = 'VIEW';
		...
		// Id_Articulo
		$this->Id_Articulo = new cField('cap_asigna_acabados_equipo', 'cap_asigna_acabados_equipo', 'x_Id_Articulo', 'Id_Articulo', '`Id_Articulo`', '`Id_Articulo`', 3, -1, FALSE, '`Id_Articulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Articulo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Articulo'] = &$this->Id_Articulo;

		// COD_Marca_eq
		$this->COD_Marca_eq = new cField('cap_asigna_acabados_equipo', 'cap_asigna_acabados_equipo', 'x_COD_Marca_eq', 'COD_Marca_eq', '`COD_Marca_eq`', '`COD_Marca_eq`', 200, -1, FALSE, '`COD_Marca_eq`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['COD_Marca_eq'] = &$this->COD_Marca_eq;

		// Articulo
		$this->Articulo = new cField('cap_asigna_acabados_equipo', 'cap_asigna_acabados_equipo', 'x_Articulo', 'Articulo', '`Articulo`', '`Articulo`', 200, -1, FALSE, '`Articulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Articulo'] = &$this->Articulo;

		// Codigo
		$this->Codigo = new cField('cap_asigna_acabados_equipo', 'cap_asigna_acabados_equipo', 'x_Codigo', 'Codigo', '`Codigo`', '`Codigo`', 200, -1, FALSE, '`Codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "cap_asigna_acabados_equipo_detail") {
			$sDetailUrl = $GLOBALS["cap_asigna_acabados_equipo_detail"]->GetListUrl() . "?showmaster=" . $this->TableVar;
	...
	function SqlFrom() { // From
		return "`cap_asigna_acabados_equipo`";
	}
	...
	// Update Table
	var $UpdateTable = "`cap_asigna_acabados_equipo`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cap_asigna_acabados_equipolist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("cap_asigna_acabados_equipoview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "cap_asigna_acabados_equipoadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cap_asigna_acabados_equipoedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cap_asigna_acabados_equipoedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cap_asigna_acabados_equipoadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cap_asigna_acabados_equipoadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cap_asigna_acabados_equipodelete.php", $this->UrlParm());
	}
