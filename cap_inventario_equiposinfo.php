...
$cap_inventario_equipos = NULL;

//
// Table class for cap_inventario_equipos
//
class ccap_inventario_equipos extends cTable {
	var $Id_Almacen;
	var $COD_Marca_eq;
	var $COD_Modelo_eq;
	var $Id_Articulo;
	...
	function __construct() {
		...
		$this->TableVar = 'cap_inventario_equipos';
		$this->TableName = 'cap_inventario_equipos';
		$this->TableType = 'VIEW';
		...
		// Id_Almacen
		$this->Id_Almacen = new cField('cap_inventario_equipos', 'cap_inventario_equipos', 'x_Id_Almacen', 'Id_Almacen', '`Id_Almacen`', '`Id_Almacen`', 3, -1, FALSE, '`Id_Almacen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Almacen->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Almacen'] = &$this->Id_Almacen;

		// COD_Marca_eq
		$this->COD_Marca_eq = new cField('cap_inventario_equipos', 'cap_inventario_equipos', 'x_COD_Marca_eq', 'COD_Marca_eq', '`COD_Marca_eq`', '`COD_Marca_eq`', 200, -1, FALSE, '`COD_Marca_eq`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['COD_Marca_eq'] = &$this->COD_Marca_eq;

		// COD_Modelo_eq
		$this->COD_Modelo_eq = new cField('cap_inventario_equipos', 'cap_inventario_equipos', 'x_COD_Modelo_eq', 'COD_Modelo_eq', '`COD_Modelo_eq`', '`COD_Modelo_eq`', 200, -1, FALSE, '`COD_Modelo_eq`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['COD_Modelo_eq'] = &$this->COD_Modelo_eq;

		// Id_Articulo
		$this->Id_Articulo = new cField('cap_inventario_equipos', 'cap_inventario_equipos', 'x_Id_Articulo', 'Id_Articulo', '`Id_Articulo`', '`Id_Articulo`', 3, -1, FALSE, '`Id_Articulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Articulo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Articulo'] = &$this->Id_Articulo;

		// Codigo
		$this->Codigo = new cField('cap_inventario_equipos', 'cap_inventario_equipos', 'x_Codigo', 'Codigo', '`Codigo`', '`Codigo`', 200, -1, FALSE, '`Codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Codigo'] = &$this->Codigo;

		// Cantidad_Actual
		$this->Cantidad_Actual = new cField('cap_inventario_equipos', 'cap_inventario_equipos', 'x_Cantidad_Actual', 'Cantidad_Actual', '`Cantidad_Actual`', '`Cantidad_Actual`', 3, -1, FALSE, '`Cantidad_Actual`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Cantidad_Actual->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Cantidad_Actual'] = &$this->Cantidad_Actual;

		// Cantidad_MustBe
		$this->Cantidad_MustBe = new cField('cap_inventario_equipos', 'cap_inventario_equipos', 'x_Cantidad_MustBe', 'Cantidad_MustBe', '`Cantidad_MustBe`', '`Cantidad_MustBe`', 3, -1, FALSE, '`Cantidad_MustBe`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Cantidad_MustBe->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Cantidad_MustBe'] = &$this->Cantidad_MustBe;

		// Cantidad_Minima
		$this->Cantidad_Minima = new cField('cap_inventario_equipos', 'cap_inventario_equipos', 'x_Cantidad_Minima', 'Cantidad_Minima', '`Cantidad_Minima`', '`Cantidad_Minima`', 3, -1, FALSE, '`Cantidad_Minima`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Cantidad_Minima->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Cantidad_Minima'] = &$this->Cantidad_Minima;

		// Cantidad_Maxima
		$this->Cantidad_Maxima = new cField('cap_inventario_equipos', 'cap_inventario_equipos', 'x_Cantidad_Maxima', 'Cantidad_Maxima', '`Cantidad_Maxima`', '`Cantidad_Maxima`', 3, -1, FALSE, '`Cantidad_Maxima`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "cap_inventario_equipos_det") {
			$sDetailUrl = $GLOBALS["cap_inventario_equipos_det"]->GetListUrl() . "?showmaster=" . $this->TableVar;
	...
	function SqlOrderBy() { // Order By
		return "`Id_Almacen` ASC,`COD_Marca_eq` ASC,`COD_Modelo_eq` ASC";
	}
	...
	// Update Table
	var $UpdateTable = "`cap_inventario_equipos`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cap_inventario_equiposlist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("cap_inventario_equiposview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "cap_inventario_equiposadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cap_inventario_equiposedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cap_inventario_equiposedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("cap_inventario_equiposadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("cap_inventario_equiposadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cap_inventario_equiposdelete.php", $this->UrlParm());
	}
