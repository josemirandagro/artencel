...
$cap_gen_barcode_accesorios_detail_grid = NULL; // Initialize page object first

class ccap_gen_barcode_accesorios_detail_grid extends ccap_gen_barcode_accesorios_detail {
	...
	// Page object name
	var $PageObjName = 'cap_gen_barcode_accesorios_detail_grid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["cap_gen_barcode_accesorios_detail"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "cap_gen_barcode_accesorios") {
			...
			if ($GLOBALS["cap_gen_barcode_accesorios"]->EventCancelled) $this->EventCancelled = TRUE;
		}
