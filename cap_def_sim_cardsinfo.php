...
$cap_def_sim_cards = NULL;

//
// Table class for cap_def_sim_cards
//
class ccap_def_sim_cards extends cTable {
	var $Id_Articulo;
	var $Articulo;
	var $Codigo;
	var $COD_Compania_eq;
	...
	function __construct() {
		...
		$this->TableVar = 'cap_def_sim_cards';
		$this->TableName = 'cap_def_sim_cards';
		$this->TableType = 'VIEW';
		...
		// Id_Articulo
		$this->Id_Articulo = new cField('cap_def_sim_cards', 'cap_def_sim_cards', 'x_Id_Articulo', 'Id_Articulo', '`Id_Articulo`', '`Id_Articulo`', 3, -1, FALSE, '`Id_Articulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id_Articulo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id_Articulo'] = &$this->Id_Articulo;

		// Articulo
		$this->Articulo = new cField('cap_def_sim_cards', 'cap_def_sim_cards', 'x_Articulo', 'Articulo', '`Articulo`', '`Articulo`', 200, -1, FALSE, '`Articulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Articulo'] = &$this->Articulo;

		// Codigo
		$this->Codigo = new cField('cap_def_sim_cards', 'cap_def_sim_cards', 'x_Codigo', 'Codigo', '`Codigo`', '`Codigo`', 200, -1, FALSE, '`Codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Codigo'] = &$this->Codigo;

		// COD_Compania_eq
		$this->COD_Compania_eq = new cField('cap_def_sim_cards', 'cap_def_sim_cards', 'x_COD_Compania_eq', 'COD_Compania_eq', '`COD_Compania_eq`', '`COD_Compania_eq`', 200, -1, FALSE, '`COD_Compania_eq`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['COD_Compania_eq'] = &$this->COD_Compania_eq;

		// Amigo_CHIP
		$this->Amigo_CHIP = new cField('cap_def_sim_cards', 'cap_def_sim_cards', 'x_Amigo_CHIP', 'Amigo_CHIP', '`Amigo_CHIP`', '`Amigo_CHIP`', 200, -1, FALSE, '`Amigo_CHIP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Amigo_CHIP'] = &$this->Amigo_CHIP;

		// Activacion_Movi
		$this->Activacion_Movi = new cField('cap_def_sim_cards', 'cap_def_sim_cards', 'x_Activacion_Movi', 'Activacion_Movi', '`Activacion_Movi`', '`Activacion_Movi`', 200, -1, FALSE, '`Activacion_Movi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Activacion_Movi'] = &$this->Activacion_Movi;

		// Precio_compra
		$this->Precio_compra = new cField('cap_def_sim_cards', 'cap_def_sim_cards', 'x_Precio_compra', 'Precio_compra', '`Precio_compra`', '`Precio_compra`', 131, -1, FALSE, '`Precio_compra`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Precio_lista_venta_publico_1 = new cField('cap_def_sim_cards', 'cap_def_sim_cards', 'x_Precio_lista_venta_publico_1', 'Precio_lista_venta_publico_1', '`Precio_lista_venta_publico_1`', '`Precio_lista_venta_publico_1`', 131, -1, FALSE, '`Precio_lista_venta_publico_1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Precio_lista_venta_publico_2 = new cField('cap_def_sim_cards', 'cap_def_sim_cards', 'x_Precio_lista_venta_publico_2', 'Precio_lista_venta_publico_2', '`Precio_lista_venta_publico_2`', '`Precio_lista_venta_publico_2`', 131, -1, FALSE, '`Precio_lista_venta_publico_2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Precio_lista_venta_publico_3 = new cField('cap_def_sim_cards', 'cap_def_sim_cards', 'x_Precio_lista_venta_publico_3', 'Precio_lista_venta_publico_3', '`Precio_lista_venta_publico_3`', '`Precio_lista_venta_publico_3`', 131, -1, FALSE, '`Precio_lista_venta_publico_3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Precio_lista_venta_medio_mayoreo = new cField('cap_def_sim_cards', 'cap_def_sim_cards', 'x_Precio_lista_venta_medio_mayoreo', 'Precio_lista_venta_medio_mayoreo', '`Precio_lista_venta_medio_mayoreo`', '`Precio_lista_venta_medio_mayoreo`', 131, -1, FALSE, '`Precio_lista_venta_medio_mayoreo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Precio_lista_venta_mayoreo = new cField('cap_def_sim_cards', 'cap_def_sim_cards', 'x_Precio_lista_venta_mayoreo', 'Precio_lista_venta_mayoreo', '`Precio_lista_venta_mayoreo`', '`Precio_lista_venta_mayoreo`', 131, -1, FALSE, '`Precio_lista_venta_mayoreo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// TipoArticulo
		$this->TipoArticulo = new cField('cap_def_sim_cards', 'cap_def_sim_cards', 'x_TipoArticulo', 'TipoArticulo', '`TipoArticulo`', '`TipoArticulo`', 202, -1, FALSE, '`TipoArticulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['TipoArticulo'] = &$this->TipoArticulo;

		// Id_Almacen_Entrada
		$this->Id_Almacen_Entrada = new cField('cap_def_sim_cards', 'cap_def_sim_cards', 'x_Id_Almacen_Entrada', 'Id_Almacen_Entrada', '`Id_Almacen_Entrada`', '`Id_Almacen_Entrada`', 3, -1, FALSE, '`Id_Almacen_Entrada`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Status
		$this->Status = new cField('cap_def_sim_cards', 'cap_def_sim_cards', 'x_Status', 'Status', '`Status`', '`Status`', 202, -1, FALSE, '`Status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`cap_def_sim_cards`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "cap_def_sim_cardslist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("cap_def_sim_cardsview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "cap_def_sim_cardsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("cap_def_sim_cardsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("cap_def_sim_cardsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cap_def_sim_cardsdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	// Nos regresamos directo a list page, para no tener que estar poniendo leltresros
	  Redireccionar('cap_def_sim_cardslist.php'); 
	  exit;  
	  return TRUE; 
	}
